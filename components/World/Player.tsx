...
export const Player: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleTouchEnd = (e: TouchEvent) => {
        ...
        if (Math.abs(deltaX) > minSwipeDist || Math.abs(deltaY) > minSwipeDist) {
            // Directional Lock: Check if swipe is more horizontal or vertical
